# Paket Kabul ve Yayın Veri Bütünlüğü — v0.16.9.4.16

## Genel sonuç: **PASS**

| Kapı | Sonuç | Kanıt |
|---|---:|---|
| Pytest | PASS | 364/364 PASS, 0 skipped |
| Yayın veri bütünlüğü | PASS | 0 blocker, 8 konuma bağlı izin |
| Hesap/model motor kilidi | PASS | 37/37 dosya byte doğrulandı |
| Manifest | PASS | 267/267 |
...
- PDF dosyası: 2/2
- PDF sayfası: 15/15
- Çıkarılan PDF metni: 36417 karakter
