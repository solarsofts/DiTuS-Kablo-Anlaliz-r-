# Paket Kabul ve Yayın Veri Bütünlüğü — v0.16.9.4.17

## Genel sonuç: **PASS**

| Kapı | Sonuç | Kanıt |
|---|---:|---|
| Pytest | PASS | 372/372 PASS, 0 skipped |
| Yayın veri bütünlüğü | PASS | 0 blocker, 8 konuma bağlı izin |
| Hesap/model motor kilidi | PASS | 38/38 dosya byte doğrulandı |
| Manifest | PASS | 280/280 |
