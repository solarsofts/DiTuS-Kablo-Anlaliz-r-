# Paket Kabul ve Yayın Veri Bütünlüğü — v0.16.9.4.27

## Genel sonuç: **PASS**

| Kapı | Sonuç | Kanıt |
|---|---:|---|
| Pytest | PASS | 462/462 PASS, 0 skipped |
| Yayın veri bütünlüğü | PASS | 0 blocker, 8 konuma bağlı izin |
| Hesap/model motor kilidi | PASS | 48/48 dosya byte doğrulandı |
| Manifest | PASS | 364/364 |
