# Paket Kabul ve Yayın Veri Bütünlüğü — v0.16.9.4.22

## Genel sonuç: **PASS**

| Kapı | Sonuç | Kanıt |
|---|---:|---|
| Pytest | PASS | 419/419 PASS, 0 skipped |
| Yayın veri bütünlüğü | PASS | 0 blocker, 8 konuma bağlı izin |
| Hesap/model motor kilidi | PASS | 43/43 dosya byte doğrulandı |
| Manifest | PASS | 316/316 |
...
- PDF dosyası: 2/2
- PDF sayfası: 18/18
- Çıkarılan PDF metni: 40577 karakter
