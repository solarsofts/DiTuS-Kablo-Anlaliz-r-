# Paket Kabul ve Yayın Veri Bütünlüğü — v0.16.9.4.34

## Genel sonuç: **PASS**

| Kapı | Sonuç | Kanıt |
|---|---:|---|
| Pytest | PASS | 502/503 PASS, 1 skipped |
| Yayın veri bütünlüğü | PASS | 0 blocker, 8 konuma bağlı izin |
| Hesap/model motor kilidi | PASS | 53/53 dosya byte doğrulandı |
| Manifest | PASS | 420/420 |
...
- PDF dosyası: 2/2
- PDF sayfası: 19/19
- Çıkarılan PDF metni: 43795 karakter
